...
async function seedDatabase() {
  ...
  if (existingTestimonials.length === 0) {
    await db.insert(testimonials).values([
      { 
        quote: "As always, we very much appreciate your hard work and the hard work of the entire BT team.", 
        author: "SVP & Chief Compliance Officer", 
        company: "Global Distribution Company" 
      },
      { 
        quote: "Bennett Thrasher provided exceptional second mile audit services for Trilith Studios. Their team was thorough, knowledgeable...", 
        author: "Ginny Hernandez", 
        company: "Trilith Studios" 
      },
      { 
        quote: "In the past, I have used two of the top four national accounting firms for advice. I have found Jeff Call's firm Bennett Thrasher, the most responsive...", 
        author: "Guy Millner", 
        company: "Chairman Assurance, America, Corporation, Atlanta" 
      },
    ]);
  }
  ...
  if (existingAwards.length === 0) {
     await db.insert(awards).values([
      ...
      { title: "Inside Public Accounting Best of the Best", year: "2025", imageUrl: "" },
